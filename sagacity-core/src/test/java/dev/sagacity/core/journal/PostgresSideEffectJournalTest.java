...
/**
 * Tests PostgresSideEffectJournal using H2 in Postgres compatibility mode.
 * For real Postgres tests, see PostgresSideEffectJournalIT (requires Docker).
 */
class PostgresSideEffectJournalTest {
	...
	void setUp() throws Exception {
		...
		ds.setURL("jdbc:h2:mem:test_" + System.nanoTime() + ";MODE=PostgreSQL;DB_CLOSE_DELAY=-1");
		ds.setUser("sa");
		ds.setPassword("");
		...
		journal = new PostgresSideEffectJournal(ds);
	}
